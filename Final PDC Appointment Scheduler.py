...
class Scheduler():
    def __init__(self):
        ...
        #Creates and displays the labels on the user interface as well the company logo 
        ...
        #The following code creates and displays the text boxes for the inputs and then takes the inputs assigning them to a StringVar variable.
        ...
        #The following code creates and displays the output variables
        ...
        #The following code creates, displays, and executes the buttons on the GUI
    ...
    #This function validates the inputs and assigns the output value on the GUI
    ...
    #This function displays the room assignment and removes room availability based on the time it is reserved for
    ...
    def schedule_coach(self, coachList):
        #This function displays the coach assignment and removes coach availability based on the time they are reserved for
        if(self.time.get() == '8 am'):
    ...
    def studentMajorErrorMessage(self):
        ...
        Label(error4, text = "BIS : Business Infromation Systems").grid(row = 11, column = 1, sticky = W)
        error4.mainloop()
...
majors = ['MKT', 'PRE', 'ACT', 'E&I', 'FIN', 'FRE', 'MANA', 'SCM', 'BIS']
